          ...
          {isHomePage ? (
            ...
            >
              <button
                ...
                className="group flex items-center gap-2 text-sm uppercase tracking-wider text-gray-300 hover:text-white transition-all duration-300 focus:outline-none rounded-lg px-4 py-2 border border-white/20 hover:border-white/40 hover:bg-white/5"
          ...
          <div className="md:hidden flex items-center space-x-4">
            {!isHomePage && (
              <button
                onClick={() => router.push("/")}
                onKeyDown={(e) => handleKeyDown(e, () => router.push("/"))}
                className="group flex items-center text-sm uppercase tracking-wider text-gray-300 hover:text-white transition-all duration-300 focus:outline-none rounded-lg px-2 py-1 border border-white/20 hover:border-white/40"
                aria-label={language === "de" ? "Zurück zur Startseite" : "Back to homepage"}
              >
